...
from lavis.datasets.builders.instr_builder import (
    VTEBuilder, TVQABuilder, InstrTuningBuilder,
    VSRBuilder, VisDialBuilder, CommonsenseVQABuilder, DCBuilder, NLVRBuilder
)
