...
from data.instr_data.tvqa_dataset import TVQAInstrDataset
...
@register_task("tvqa", dataclass=TVQAConfig)
class TVQATask(OFATask):
    def __init__(self, cfg: TVQAConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = TVQAInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
