...
from data.instr_data.visdial_dataset import VisDialInstrDataset
...
@register_task("visdial", dataclass=VisDialConfig)
class VisDialTask(OFATask):
    def __init__(self, cfg: VisDialConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VisDialInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
