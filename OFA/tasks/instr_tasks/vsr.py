...
from data.instr_data.vsr_dataset import VSRInstrDataset
...
@register_task("vsr", dataclass=VSRConfig)
class VSRTask(OFATask):
    def __init__(self, cfg: VSRConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VSRInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
