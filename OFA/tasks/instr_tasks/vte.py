...
from data.instr_data.vte_dataset import VteInstrDataset
...
@register_task("vte", dataclass=VteConfig)
class VteTask(OFATask):
    def __init__(self, cfg: VteConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VteInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
    ...
    def valid_step(self, sample, model, criterion):
        ...
        model.eval()
        if self.cfg.eval_bleu or self.cfg.eval_cider or self.cfg.eval_rouge:
