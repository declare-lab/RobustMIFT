...
from data.instr_data.groundedvqa_dataset import GroundedVQAMCInstrDataset
...
@dataclass
class GroundedVQAConfig(OFAConfig):
...
@register_task("grounded_vqa_mc", dataclass=GroundedVQAConfig)
class GroundedVQAMCTask(OFATask):
    def __init__(self, cfg: GroundedVQAConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = GroundedVQAMCInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
