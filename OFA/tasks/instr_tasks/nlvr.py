...
from data.instr_data.nlvr_dataset import NLVRInstrDataset
...
@register_task("nlvr", dataclass=NLVRConfig)
class NLVRTask(OFATask):
    def __init__(self, cfg: NLVRConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = NLVRInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
