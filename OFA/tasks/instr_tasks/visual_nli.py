...
from data.instr_data.visualnli_dataset import VisualNLIInstrDataset
...
@dataclass
class VisualNLIConfig(OFAConfig):
...
@register_task("visual_nli", dataclass=VisualNLIConfig)
class VisualNLITask(OFATask):
    def __init__(self, cfg: VisualNLIConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VisualNLIInstrDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
