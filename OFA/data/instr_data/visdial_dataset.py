...
class VisDialInstrDataset(OFADataset):
    def __init__(
        self,
        split,
        dataset,
    ...
    def __getitem__(self, index):
        ...
        uniq_id, image, _, prompt, target = item
        ...
        src_item = self.encode_text(' {}'.format(prompt), dic='src')
        src_item = torch.cat([self.bos_item, src_item, self.eos_item])

        tgt_item = self.encode_text(" {}".format(target), dic='tgt')
